...
namespace DbZip
{
	...
	public class Options
	{
		...
		[Option('U', "UserID", HelpText = "Sets the user ID to be used when connecting to SQL Server. If no user ID is supplied then current Windows account credentials are used.")]
		public string UserID { get; set; }

		[Option('P', "Password", HelpText = "Sets the password to be used when connecting to SQL Server. If no password is supplied then current Windows account credentials are used.")]
